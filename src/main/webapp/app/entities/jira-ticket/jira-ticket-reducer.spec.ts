...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JIRATICKET_LIST actions', async () => {
    ...
    it('dispatches FETCH_JIRATICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JIRATICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JIRATICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JIRATICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JIRATICKET actions', async () => {
      const expectedActions = [
        {
