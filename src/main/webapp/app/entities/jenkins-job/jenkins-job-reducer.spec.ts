...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JENKINSJOB_LIST actions', async () => {
    ...
    it('dispatches FETCH_JENKINSJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JENKINSJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JENKINSJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JENKINSJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JENKINSJOB actions', async () => {
      const expectedActions = [
        {
